...
const QUESTIONS = [
  ...
  "Feeling unusually confident or self-assured",
  "Needing much less sleep than usual",
  "Talking more than usual or feeling pressured to talk",
  "Racing thoughts or difficulty slowing your mind",
  "Being easily distracted",
  "Starting many projects or taking on too much",
  "Spending more money than you intended",
  "Taking risks you normally would avoid",
  "Feeling irritable or agitated more than usual",
];
...
const AssessmentMoodDisorder = () => {
  ...
  const getSeverity = (score: number) => {
    if (score <= 5) return { level: "Minimal", diagnosis: "Minimal mood elevation symptoms" };
    if (score <= 10) return { level: "Mild", diagnosis: "Mild mood elevation symptoms" };
    if (score <= 18) return { level: "Moderate", diagnosis: "Moderate mood elevation symptoms" };
    return { level: "Severe", diagnosis: "Severe mood elevation symptoms" };
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary to-background">
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold">Mood Disorder Screening</h1>
            <p className="text-muted-foreground">Helps identify mood elevation symptoms</p>
          </div>
        </div>
...
export default AssessmentMoodDisorder;
