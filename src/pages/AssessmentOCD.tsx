...
const QUESTIONS = [
  "Unwanted intrusive thoughts that are hard to dismiss",
  "Worry about contamination (germs, dirt) or needing things to feel clean",
  "Repeated checking (locks, switches, messages) even when you know it's okay",
  "Need for symmetry, exactness, or things to feel 'just right'",
  "Compulsions that you feel driven to do to reduce anxiety",
  "Spending a lot of time on rituals or repeated behaviors",
  "Avoiding situations because of obsessions or compulsions",
  "Distress or interference with daily life because of these symptoms",
];
...
const AssessmentOCD = () => {
  ...
  const getSeverity = (score: number) => {
    if (score <= 6) return { level: "Minimal", diagnosis: "Minimal obsessive-compulsive symptoms" };
    if (score <= 12) return { level: "Mild", diagnosis: "Mild obsessive-compulsive symptoms" };
    if (score <= 20) return { level: "Moderate", diagnosis: "Moderate obsessive-compulsive symptoms" };
    return { level: "Severe", diagnosis: "Severe obsessive-compulsive symptoms" };
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary to-background">
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold">OCD Screening</h1>
            <p className="text-muted-foreground">Obsessive-compulsive symptoms check</p>
          </div>
        </div>
